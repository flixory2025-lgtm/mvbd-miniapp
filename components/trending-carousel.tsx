...
const trendingIds = [3204, 3203, 3201, 3200, 3199, 3198, 3197, 3196, 3195, 3194, 3228, 3229, 3230, 3158, 3159, 3160, 3161, 3162, 3163, 3164, 3166, 3169, 3170, 3171, 3174, 3175, 3176, 3177, 3178, 3179, 3180, 3181, 3182, 3227, 3226, 3223, 3222, 3221, 3220, 3219, 3218, 3215,]
  ...
  return (
    <section className="px-4 py-2">
      <div className="relative flex justify-center -mt-4 mb-0">
        ...
        <img
          src="https://i.postimg.cc/0NVvbFgH/17311-removebg-preview.png"
