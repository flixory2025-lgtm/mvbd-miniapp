...
const trendingIds = [3204, 3203, 3201, 3200, 3199, 3198, 3197, 3196, 3195, 3194, 3155, 3156, 3157, 3158, 3159, 3160, 3161, 3162, 3163, 3164, 3166, 3169, 3170, 3171, 3174, 3175, 3176, 3177, 3178, 3179, 3180, 3181, 3182, 3183, 3184, 3185, 3186, 3188, 3189, 3190, 3191, 3192,]
  ...
  return (
    <section className="px-4 py-2">
      <div className="relative flex justify-center -mt-4 mb-0">
        ...
        <img
          src="https://i.postimg.cc/gJ5JbzS7/file-000000004e4082109e2412f9f340d990.png"
