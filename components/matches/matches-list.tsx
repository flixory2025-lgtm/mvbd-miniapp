...
const DEMO_DATA = {
  football: {
    live: [
      { id: "1", homeTeam: { name: "Manchester City" }, awayTeam: { name: "Liverpool" }, status: "LIVE", score: { home: 2, away: 1 }, minute: 67 },
      { id: "2", homeTeam: { name: "Real Madrid" }, awayTeam: { name: "Barcelona" }, status: "LIVE", score: { home: 1, away: 0 }, minute: 34 },
    ],
    upcoming: [
