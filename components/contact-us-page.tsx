...
import { Phone, Mail, MessageCircle, Youtube, Music, Send, ArrowLeft } from "lucide-react"
    ...
    <div className="min-h-screen bg-gradient-to-br from-[#0a0a12] via-[#050508] to-[#020206] pb-24">
      ...
      <div className="sticky top-0 z-40 backdrop-blur-2xl bg-black/40 border-b border-white/10 shadow-xl">
        <div className="px-4 py-4 flex items-center gap-4">
          ...
          <h1 className="text-white font-bold text-2xl bg-gradient-to-r from-white to-white/80 bg-clip-text text-transparent flex-1">
            Contact Us
          </h1>
        </div>
      </div>
