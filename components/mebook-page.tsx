...
/* ============================================================
FIREBASE â€” explicit named imports
============================================================ */
...
if (code.includes("popup-blocked")) return "Popup blocked â€” please allow popups"
if (code.includes("network")) return "Network error"
if (code.includes("too-many-requests")) return "Too many attempts â€” try again later"
...
/* ============================================================
FB-STYLE COMMENTS (mobile bottom sheet)
============================================================ */
...
.mebook-root .cmt-sheet-head::before{
...
/* ============================================================
POPUP / MODAL SYSTEM â€” fixed viewport, no background scroll, liquid glass
============================================================ */
...
.mebook-root .cmt-sheet{overscroll-behavior:contain;}
...
.mebook-root.dark-mode .mb-modal,.mebook-root.dark-mode .share-sheet{background:rgba(8,8,8,.88);border-color:rgba(255,255,255,.12);box-shadow:0 28px 90px rgba(0,0,0,.72),0 1px 0 rgba(255,255,255,.08) inset;}
...
// Real-time profile listener â€” so admin verify instantly updates
...
showToast("Password reset email sent âœ…")
} catch (e: any) {
showToast(e.message)
}
}
...
caption:
(caption ? caption + "\n\n" : "") +
ðŸ” Shared from ${sharePost.authorName || "MeBook"}+ (sharePost.movie ? Â· ðŸŽ¬ ${sharePost.movie} : ""),
...
closeShare()
showToast("Shared to your profile âœ“")
goTo("home")
} catch (e: any) {
console.error(e)
...
showToast("You are now friends ðŸŽ‰")
} catch (e: any) {
showToast(e.message)
}
}
...
showToast("Cover photo updated âœ“")
} catch (e: any) {
showToast("Upload failed: " + e.message)
}
}
...
const isVerified = u.verified === true || u.isOfficial === true
...
/* ---- Modal / popup background scroll lock ---- */
useEffect(() => {
const popupOpen = composerOpen || editOpen || userModalOpen || !!commentPost || !!sharePost
if (popupOpen) {
document.documentElement.classList.add("mebook-popup-open")
document.body.classList.add("mebook-popup-open")
} else {
document.documentElement.classList.remove("mebook-popup-open")
document.body.classList.remove("mebook-popup-open")
}
return () => {
document.documentElement.classList.remove("mebook-popup-open")
document.body.classList.remove("mebook-popup-open")
...
<p className="auth-sub">Movie lovers' social network ðŸŽ¬</p>

<div className="auth-tabs">
<button
type="button"
className={auth-tab ${authMode === "signin" ? "active" : ""}} onClick={() =&gt; { setAuthMode("signin") setAuthErr({ si: "", su: "" }) }} &gt; Sign In &lt;/button&gt; &lt;button type="button" className={auth-tab ${authMode === "signup" ? "active" : ""}}
onClick={() => {
setAuthMode("signup")
setAuthErr({ si: "", su: "" })
}}
...
<div>
<span className="cmt-count">{commentsCount}</span> comments Â·{" "}
...
{/* DRAWER */}
<div className={mb-overlay${drawerOpen ? "open" : ""}} onClick={() =&gt; setDrawerOpen(false)} /&gt; &lt;aside className={mb-drawer ${drawerOpen ? "open" : ""}}>
...
return (
<div
className={msgr-item ${isActive ? "active" : ""}} key={c.id} onClick={() =&gt; openChat(c.id, c.otherId, c.other)} &gt; &lt;div className="msgr-item-avatar-wrap"&gt; &lt;img src={photo} alt="" /&gt; &lt;span className="msgr-item-dot" /&gt; &lt;/div&gt; &lt;div className="msgr-item-body"&gt; &lt;div className="msgr-item-name"&gt; {c.other.name} {isVerified(c.other) && ( &lt;svg width="13" height="13" viewBox="0 0 24 24" fill="#22c55e" style={{ marginLeft: 4, verticalAlign: "middle", display: "inline" }} &gt; &lt;path d="M23 12l-2.44-2.79.34-3.69-3.61-.82-1.89-3.2L12 2.96 8.6 1.5 6.71 4.69l-3.61.82.34 3.69L1 12l2.44 2.79-.34 3.7 3.61.82L8.6 22.5l3.4-1.47 3.4 1.46 1.89-3.19 3.61-.82-.34-3.69L23 12zm-12.91 4.72l-3.8-3.81 1.48-1.48 2.32 2.33 5.85-5.87 1.48 1.48-7.33 7.35z" /&gt; &lt;/svg&gt; )} &lt;/div&gt; &lt;div className={msgr-item-last ${unreadCount &gt; 0 ? "unread" : ""}}>
{(c.last as any)?.text || "Say hi ðŸ‘‹"}
</div>
</div>
...
const time = m.at
? new Date(m.at.seconds * 1000).toLocaleTimeString([], {
hour: "2-digit",
minute: "2-digit",
})
: ""
...
{/* MEBOOK */}
<section className={mb-view${currentView === "mebook" ? "active" : ""}}&gt; &lt;div className="mb-mebook-hero"&gt; &lt;h2&gt;ðŸ“– Welcome to MeBook&lt;/h2&gt; &lt;p&gt;Your personal movie library, watchlist, and review hub â€” all in one place.&lt;/p&gt; &lt;span className="mb-mebook-badge"&gt;ðŸŽ¬ Powered by MeBook Community&lt;/span&gt; &lt;/div&gt; &lt;div className="mb-mebook-grid"&gt; &lt;div className="mb-mebook-stat"&gt; &lt;div className="num"&gt;128&lt;/div&gt; &lt;div className="lbl"&gt;Movies Reviewed&lt;/div&gt; &lt;/div&gt; &lt;div className="mb-mebook-stat"&gt; &lt;div className="num"&gt;42&lt;/div&gt; &lt;div className="lbl"&gt;In Watchlist&lt;/div&gt; &lt;/div&gt; &lt;div className="mb-mebook-stat"&gt; &lt;div className="num"&gt;17&lt;/div&gt; &lt;div className="lbl"&gt;Reviews Written&lt;/div&gt; &lt;/div&gt; &lt;div className="mb-mebook-stat"&gt; &lt;div className="num"&gt;9&lt;/div&gt; &lt;div className="lbl"&gt;Favorites&lt;/div&gt; &lt;/div&gt; &lt;/div&gt; &lt;div className="mb-mebook-tabs"&gt; {[ { id: "featured", label: "â­ Featured" }, { id: "watchlist", label: "ðŸ“Œ Watchlist" }, { id: "favorites", label: "â¤ï¸ Favorites" }, { id: "notes", label: "ðŸ“ My Notes" }, ].map((t) =&gt; ( &lt;button key={t.id} className={mb-mebook-tab latex
{mebookTab === t.id ? "active" : ""}`} onClick={() =&gt; { setMebookTab(t.id) if (t.id !== "featured") showToast(`

{t.label} coming soon) }} &gt; {t.label} &lt;/button&gt; ))} &lt;/div&gt; &lt;div&gt; &lt;div className="mb-card" style={{ marginBottom: 16 }}&gt; &lt;div className="mb-card-title"&gt;ðŸŽ¬ Editor's Picks This Week&lt;/div&gt; &lt;div className="mb-mebook-list"&gt; {[ { img: "https://image.tmdb.org/t/p/w200/8cdWjvZQUExUUTzyp4t6EDMubfO.jpg", seed: "dune", title: "Dune: Part Two", desc: "Paul Atreides unites with Chani and the Fremen while seeking revenge.", meta: "â­ 8.7 â€¢ Sci-Fi â€¢ 2024" }, { img: "https://image.tmdb.org/t/p/w200/iuFNMS8U5cb6xfzi51Dbkovj7vM.jpg", seed: "oppen", title: "Oppenheimer", desc: "The story of J. Robert Oppenheimer and the atomic bomb.", meta: "â­ 8.5 â€¢ Biography â€¢ 2023" }, { img: "https://image.tmdb.org/t/p/w200/1E5baAaEse26fej7uHcjOgEE2t2.jpg", seed: "inter", title: "Interstellar", desc: "Explorers travel through a wormhole in search of a new home.", meta: "â­ 8.7 â€¢ Adventure â€¢ 2014" }, { img: "https://image.tmdb.org/t/p/w200/gEU2QniE6E77NI6lCU6MxlNBvIx.jpg", seed: "incept", title: "Inception", desc: "A thief plants an idea in a target's subconscious.", meta: "â­ 8.8 â€¢ Sci-Fi â€¢ 2010" }, ].map((m) =&gt; ( &lt;div className="mb-mebook-item" key={m.title}&gt; &lt;img src={m.img} onError={(e) =&gt; { ;(e.target as HTMLImageElement).src =https://picsum.photos/seed/${m.seed}/200/260
}}
/>
...
<div className="mb-card-title">ðŸ’¡ Quick Actions</div>
...
<div className="mb-mebook-item-meta">Tap to create â†’</div>
</div>
</div>
...
<div className="mb-mebook-item-meta">Explore â†’</div>
</div>
</div>
</div>
</div>
...
<div className="mb-profile-bio">{profile.bio || "Movie lover ðŸŽ¬"}</div>
</div>
</div>
...
isOfficial: true,
caption:
"ðŸŽ‰ Welcome to the MeBook Community! Share your favourite movie screenshots & reviews. Use #MeBookReview to get featured!",
...
<div className="mb-card">
<div className="mb-card-title">ðŸ”¥ Trending Now</div>
{[
{ img: "https://image.tmdb.org/t/p/w92/8cdWjvZQUExUUTzyp4t6EDMubfO.jpg", seed: "m1", name: "Dune: Part Two", meta: "â­ 8.7 â€¢ Sci-Fi" },
{ img: "https://image.tmdb.org/t/p/w92/iuFNMS8U5cb6xfzi51Dbkovj7vM.jpg", seed: "m2", name: "Oppenheimer", meta: "â­ 8.5 â€¢ Biography" },
{ img: "https://image.tmdb.org/t/p/w92/1E5baAaEse26fej7uHcjOgEE2t2.jpg", seed: "m3", name: "Interstellar", meta: "â­ 8.7 â€¢ Adventure" },
 ].map((m) => (
...
<div className="mb-card">
<div className="mb-card-title">ðŸ‘¥ Online Friends</div>
{onlineList.length === 0 ? (
...
{/* =====================================================
COMMENTS SHEET (mobile bottom sheet â€” FB style)
===================================================== */}
<div
className={cmt-backdrop${commentPost ? "open" : ""}} onClick={closeComments} /&gt; &lt;div className={cmt-sheet ${commentPost ? "open" : ""}}>
...
disabled={shareBusy}
>
{shareBusy ? "Sharing..." : "ðŸ” Share to My Profile"}
</button>
</div>
</div>
</div>
...
COMPOSER MODAL
===================================================== */}
<div className={mb-modal-overlay${composerOpen ? "open" : ""}}&gt; &lt;div className="mb-modal"&gt; &lt;div className="mb-modal-head"&gt; Create Post &lt;button className="mb-modal-close" onClick={() =&gt; setComposerOpen(false)}&gt; &lt;svg viewBox="0 0 24 24"&gt; &lt;path d="M19 6.41 17.59 5 12 10.59 6.41 5 5 6.41 10.59 12 5 17.59 6.41 19 12 13.41 17.59 19 19 17.59 13.41 12z" /&gt; &lt;/svg&gt; &lt;/button&gt; &lt;/div&gt; &lt;div className="mb-modal-body"&gt; &lt;div className="mb-modal-user"&gt; &lt;img src={avatarUrl(profile)} alt="You" /&gt; &lt;div&gt; &lt;b&gt;{profile.name}&lt;/b&gt; &lt;div style={{ fontSize: 12, color: "var(--text-muted)" }}&gt;Public&lt;/div&gt; &lt;/div&gt; &lt;/div&gt; &lt;textarea className="mb-modal-textarea" placeholder="What's your take on this movie? Share your review..." value={postText} onChange={(e) =&gt; setPostText(e.target.value)} /&gt; &lt;div className="mb-movie-tag"&gt; &lt;svg viewBox="0 0 24 24"&gt; &lt;path d="M18 4l2 4h-3l-2-4h-2l2 4h-3l-2-4H8l2 4H7L5 4H4c-1.1 0-1.99.9-1.99 2L2 18c0 1.1.9 2 2 2h16c1.1 0 2-.9 2-2V4h-4z" /&gt; &lt;/svg&gt; &lt;input type="text" placeholder="Movie name (e.g. Interstellar)" value={postMovie} onChange={(e) =&gt; setPostMovie(e.target.value)} /&gt; &lt;/div&gt; {!previewUrl ? ( &lt;div&gt; &lt;div className="mb-upload-box" onClick={() =&gt; document.getElementById("mebook-file-input")?.click()} &gt; &lt;svg viewBox="0 0 24 24"&gt; &lt;path d="M21 19V5c0-1.1-.9-2-2-2H5c-1.1 0-2 .9-2 2v14c0 1.1.9 2 2 2h14c1.1 0 2-.9 2-2zM8.5 13.5l2.5 3.01L14.5 12l4.5 6H5l3.5-4.5z" /&gt; &lt;/svg&gt; &lt;b&gt;Add movie screenshot / photo&lt;/b&gt; &lt;small&gt;PNG, JPG up to 10MB&lt;/small&gt; &lt;/div&gt; &lt;input type="file" id="mebook-file-input" accept="image/*" style={{ display: "none" }} onChange={handlePreviewFile} /&gt; &lt;/div&gt; ) : ( &lt;div className="mb-preview"&gt; &lt;img src={previewUrl} alt="preview" /&gt; &lt;button className="mb-preview-remove" onClick={removePreview}&gt; &lt;svg viewBox="0 0 24 24"&gt; &lt;path d="M19 6.41 17.59 5 12 10.59 6.41 5 5 6.41 10.59 12 5 17.59 6.41 19 12 13.41 17.59 19 19 17.59 13.41 12z" /&gt; &lt;/svg&gt; &lt;/button&gt; &lt;/div&gt; )} {uploadProgress !== null && ( &lt;div style={{ marginTop: 10 }}&gt; &lt;div style={{ height: 6, background: "var(--border)", borderRadius: 3, overflow: "hidden", }} &gt; &lt;div style={{ height: "100%", width:${uploadProgress}%,
background: "var(--green)",
